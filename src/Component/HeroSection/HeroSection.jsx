      ...
      <section className=" pt-10 md:pt-20 mt-8 md:mt-16 custom-radial-gradient md:h-screen">
        <div className="2xl:container mx-auto">
          <div className="w-[90%] mx-auto ">
            <div className=" pt-20 h-fit w-full md:py-10 flex flex-col justify-center items-center space-y-6 md:space-y-8 2xl:space-y-10">
              ...
              <Link to="#contact_form" smooth>
                <button className="w-[150px] md:w-[190px] h-[40px] md:h-[65px] bg-[#303030] rounded flex justify-center items-center">
            ...
            <div className="text-white flex items-center pt-12 justify-end flex-col font-medium font-['Alegreya_Sans']">
                <p>Our Services</p>
